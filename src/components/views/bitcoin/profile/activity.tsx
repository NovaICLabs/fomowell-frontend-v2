...
import { useBtcInfiniteUserActivity } from "@/hooks/apis/indexer_btc";
import {
	formatNumberSmart,
	formatUnits,
				...
				cell: (info) => {
					...
					return (
						<div className="flex h-full w-full items-center">
							<span className="text-sm leading-4 text-white/60">
								{formatNumberSmart(
									formatUnits(amount, getCkbtcCanisterToken().decimals)
								)}{" "}
								BTC
							</span>
						</div>
