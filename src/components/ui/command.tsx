	...
	return (
		...
		>
			...
			<CommandPrimitive.Input
				...
				className={cn(
					"placeholder:text-muted-foreground flex h-10 w-full rounded-xl bg-gray-800 py-3 text-sm outline-hidden disabled:cursor-not-allowed disabled:opacity-50",
					className
				)}
				{...props}
				ref={ref}
...
function CommandList({
	...
	return (
		<CommandPrimitive.List
			className={cn("scroll-py-3 overflow-x-hidden", className)}
