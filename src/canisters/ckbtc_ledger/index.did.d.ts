...
export type Result_1 = { Ok: bigint } | { Err: TransferError };
export type Result_2 = { Ok: ConsentInfo } | { Err: Icrc21Error };
export type Result_3 = { Ok: bigint } | { Err: ApproveError };
export type Result_4 = { Ok: bigint } | { Err: TransferFromError };
...
export interface _SERVICE {
	...
	icrc1_transfer: ActorMethod<[TransferArg], Result_1>;
